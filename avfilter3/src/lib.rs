...
pub struct Struct_AVFilterBuffer {
    ...
    pub free: ::std::option::Option<extern "C" fn(buf:
                                                      *mut Struct_AVFilterBuffer)
                                        -> ()>,
...
impl ::std::clone::Clone for Struct_AVFilterBuffer {
    fn clone(&self) -> Struct_AVFilterBuffer { *self }
}
impl ::std::default::Default for Struct_AVFilterBuffer {
    fn default() -> Struct_AVFilterBuffer { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::clone::Clone for Struct_AVFilterBufferRefAudioProps {
    fn clone(&self) -> Struct_AVFilterBufferRefAudioProps { *self }
}
impl ::std::default::Default for Struct_AVFilterBufferRefAudioProps {
    fn default() -> Struct_AVFilterBufferRefAudioProps {
...
impl ::std::clone::Clone for Struct_AVFilterBufferRefVideoProps {
    fn clone(&self) -> Struct_AVFilterBufferRefVideoProps { *self }
}
impl ::std::default::Default for Struct_AVFilterBufferRefVideoProps {
    fn default() -> Struct_AVFilterBufferRefVideoProps {
        unsafe { ::std::mem::zeroed() }
    }
}
...
impl ::std::clone::Clone for Struct_AVFilterBufferRef {
    fn clone(&self) -> Struct_AVFilterBufferRef { *self }
}
impl ::std::default::Default for Struct_AVFilterBufferRef {
    fn default() -> Struct_AVFilterBufferRef {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub struct Struct_AVFilterPad {
    ...
    pub start_frame: ::std::option::Option<extern "C" fn(link:
                                                             *mut AVFilterLink,
                                                         picref:
                                                             *mut AVFilterBufferRef)
                                               -> ::libc::c_int>,
    pub get_video_buffer: ::std::option::Option<extern "C" fn(link:
                                                                  *mut AVFilterLink,
                                                              w:
                                                                  ::libc::c_int,
                                                              h:
                                                                  ::libc::c_int)
                                                    -> *mut avutil::AVFrame>,
    pub get_audio_buffer: ::std::option::Option<extern "C" fn(link:
                                                                  *mut AVFilterLink,
                                                              nb_samples:
                                                                  ::libc::c_int)
                                                    -> *mut avutil::AVFrame>,
    pub end_frame: ::std::option::Option<extern "C" fn(link:
                                                           *mut AVFilterLink)
                                             -> ::libc::c_int>,
    pub draw_slice: ::std::option::Option<extern "C" fn(link:
                                                            *mut AVFilterLink,
                                                        y: ::libc::c_int,
                                                        height: ::libc::c_int,
                                                        slice_dir:
                                                            ::libc::c_int)
                                              -> ::libc::c_int>,
    pub filter_frame: ::std::option::Option<extern "C" fn(link:
                                                              *mut AVFilterLink,
                                                          frame: *mut avutil::AVFrame)
                                                -> ::libc::c_int>,
    pub poll_frame: ::std::option::Option<extern "C" fn(link:
                                                            *mut AVFilterLink)
                                              -> ::libc::c_int>,
    pub request_frame: ::std::option::Option<extern "C" fn(link:
                                                               *mut AVFilterLink)
                                                 -> ::libc::c_int>,
    pub config_props: ::std::option::Option<extern "C" fn(link:
                                                              *mut AVFilterLink)
                                                -> ::libc::c_int>,
    pub needs_fifo: ::libc::c_int,
    pub needs_writable: ::libc::c_int,
}
impl ::std::clone::Clone for Struct_AVFilterPad {
    fn clone(&self) -> Struct_AVFilterPad { *self }
}
impl ::std::default::Default for Struct_AVFilterPad {
    fn default() -> Struct_AVFilterPad { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy)]
pub struct Struct_AVFilter {
    ...
    pub init: ::std::option::Option<extern "C" fn(ctx: *mut AVFilterContext)
                                        -> ::libc::c_int>,
    pub init_dict: ::std::option::Option<extern "C" fn(ctx:
                                                           *mut AVFilterContext,
                                                       options:
                                                           *mut *mut avutil::AVDictionary)
                                             -> ::libc::c_int>,
    pub uninit: ::std::option::Option<extern "C" fn(ctx: *mut AVFilterContext)
                                          -> ()>,
    pub query_formats: ::std::option::Option<extern "C" fn(arg1:
                                                               *mut AVFilterContext)
                                                 -> ::libc::c_int>,
    pub priv_size: ::libc::c_int,
    pub next: *mut Struct_AVFilter,
    pub process_command: ::std::option::Option<extern "C" fn(arg1:
                                                                 *mut AVFilterContext,
                                                             cmd:
                                                                 *const ::libc::c_char,
                                                             arg:
                                                             ...
                                                             flags:
                                                                 ::libc::c_int)
                                                   -> ::libc::c_int>,
    pub init_opaque: ::std::option::Option<extern "C" fn(ctx:
                                                             *mut AVFilterContext,
                                                         opaque:
                                                             *mut ::libc::c_void)
                                               -> ::libc::c_int>,
}
impl ::std::clone::Clone for Struct_AVFilter {
    fn clone(&self) -> Struct_AVFilter { *self }
}
impl ::std::default::Default for Struct_AVFilter {
    fn default() -> Struct_AVFilter { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::clone::Clone for Struct_AVFilterContext {
    fn clone(&self) -> Struct_AVFilterContext { *self }
}
impl ::std::default::Default for Struct_AVFilterContext {
    fn default() -> Struct_AVFilterContext { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::clone::Clone for Struct_AVFilterLink {
    fn clone(&self) -> Struct_AVFilterLink { *self }
}
impl ::std::default::Default for Struct_AVFilterLink {
    fn default() -> Struct_AVFilterLink { unsafe { ::std::mem::zeroed() } }
}

pub type Enum_Unnamed1 = ::libc::c_uint;
pub const AVLINK_UNINIT: ::libc::c_uint = 0;
pub const AVLINK_STARTINIT: ::libc::c_uint = 1;
pub const AVLINK_INIT: ::libc::c_uint = 2;
...
pub type avfilter_action_func =
    extern "C" fn(ctx: *mut AVFilterContext, arg: *mut ::libc::c_void,
                  jobnr: ::libc::c_int, nb_jobs: ::libc::c_int)
        -> ::libc::c_int;
pub type avfilter_execute_func =
    extern "C" fn(ctx: *mut AVFilterContext, func: *mut avfilter_action_func,
                  arg: *mut ::libc::c_void, ret: *mut ::libc::c_int,
                  nb_jobs: ::libc::c_int) -> ::libc::c_int;
#[repr(C)]
#[derive(Copy)]
...
impl ::std::clone::Clone for Struct_AVFilterGraph {
    fn clone(&self) -> Struct_AVFilterGraph { *self }
}
impl ::std::default::Default for Struct_AVFilterGraph {
    fn default() -> Struct_AVFilterGraph { unsafe { ::std::mem::zeroed() } }
}
pub type AVFilterGraph = Struct_AVFilterGraph;
pub type Enum_Unnamed2 = ::libc::c_int;
pub const AVFILTER_AUTO_CONVERT_ALL: ::libc::c_int = 0;
pub const AVFILTER_AUTO_CONVERT_NONE: ::libc::c_int = -1;
#[repr(C)]
#[derive(Copy)]
...
impl ::std::clone::Clone for Struct_AVFilterInOut {
    fn clone(&self) -> Struct_AVFilterInOut { *self }
}
impl ::std::default::Default for Struct_AVFilterInOut {
    fn default() -> Struct_AVFilterInOut { unsafe { ::std::mem::zeroed() } }
}
...
extern "C" {
    ...
    pub fn avfilter_config_links(filter: *mut AVFilterContext)
     -> ::libc::c_int;
    pub fn avfilter_get_video_buffer_ref_from_arrays(data: *mut *mut uint8_t,
                                                     linesize:
                                                         *mut ::libc::c_int,
                                                     perms: ::libc::c_int,
                                                     w: ::libc::c_int,
...
pub fn version() -> u32 {
    unsafe { avfilter_version() as u32 }
}

pub fn license() -> &'static str {
    std::str::from_utf8(unsafe { std::ffi::CStr::from_ptr(avfilter_license()) }.to_bytes()).ok().expect("invalid utf8")
}
