...
use libc::{uint8_t,int64_t,uint64_t,FILE,size_t};
...
pub enum Struct_AVDeviceInfoList { }
#[repr(C)]
#[derive(Copy)]
...
pub struct Struct_AVOutputFormat {
    ...
    pub get_output_timestamp: ::std::option::Option<extern "C" fn(s:
                                                                  ...
                                                                  wall:
                                                                      *mut int64_t)
                                                        -> ()>,
    pub control_message: ::std::option::Option<extern "C" fn(s:
                                                                 *mut Struct_AVFormatContext,
                                                             _type:
                                                                 ::libc::c_int,
                                                             data:
                                                             ...
                                                             data_size:
                                                                 size_t)
                                                   -> ::libc::c_int>,
    pub write_uncoded_frame: ::std::option::Option<extern "C" fn(arg1:
                                                                     *mut Struct_AVFormatContext,
                                                                 stream_index:
                                                                     ::libc::c_int,
                                                                 frame:
                                                                     *mut *mut avutil::AVFrame,
                                                                 flags:
                                                                     ::libc::c_uint)
                                                       -> ::libc::c_int>,
    pub get_device_list: ::std::option::Option<extern "C" fn(s:
                                                                 *mut Struct_AVFormatContext,
                                                             device_list:
...
pub struct Struct_AVStream {
    ...
    pub pts_reorder_error: [int64_t; 17usize],
    pub pts_reorder_error_count: [uint8_t; 17usize],
...
pub type av_format_control_message =
    ::std::option::Option<extern "C" fn(s: *mut Struct_AVFormatContext,
                                        _type: ::libc::c_int,
...
pub enum Struct_AVFormatInternal { }
...
pub struct Struct_AVFormatContext {
    ...
    pub offset: int64_t,
    pub offset_timebase: avutil::AVRational,
    pub internal: *mut AVFormatInternal,
    pub io_repositioned: ::libc::c_int,
    pub video_codec: *mut avcodec::AVCodec,
    pub audio_codec: *mut avcodec::AVCodec,
    pub subtitle_codec: *mut avcodec::AVCodec,
...
extern "C" {
    ...
    pub fn av_append_packet(s: *mut AVIOContext, pkt: *mut avcodec::AVPacket,
                            size: ::libc::c_int) -> ::libc::c_int;
    pub fn av_stream_get_r_frame_rate(s: *const AVStream) -> avutil::AVRational;
    pub fn av_stream_set_r_frame_rate(s: *mut AVStream, r: avutil::AVRational) -> ();
    pub fn av_format_get_probe_score(s: *const AVFormatContext)
     -> ::libc::c_int;
    pub fn av_format_get_video_codec(s: *const AVFormatContext)
     -> *mut avcodec::AVCodec;
    pub fn av_format_set_video_codec(s: *mut AVFormatContext, c: *mut avcodec::AVCodec)
     -> ();
    pub fn av_format_get_audio_codec(s: *const AVFormatContext)
     -> *mut avcodec::AVCodec;
    pub fn av_format_set_audio_codec(s: *mut AVFormatContext, c: *mut avcodec::AVCodec)
     -> ();
    pub fn av_format_get_subtitle_codec(s: *const AVFormatContext)
     -> *mut avcodec::AVCodec;
    pub fn av_format_set_subtitle_codec(s: *mut AVFormatContext,
                                        c: *mut avcodec::AVCodec) -> ();
    ...
    pub fn av_write_uncoded_frame(s: *mut AVFormatContext,
                                  ...
                                  frame: *mut avutil::AVFrame) -> ::libc::c_int;
    ...
    pub fn avformat_get_mov_video_tags() -> *const Struct_AVCodecTag;
    pub fn avformat_get_mov_audio_tags() -> *const Struct_AVCodecTag;
    ...
    pub fn av_guess_frame_rate(ctx: *mut AVFormatContext,
                               stream: *mut AVStream, frame: *mut avutil::AVFrame)
     -> avutil::AVRational;
