...
impl ::std::clone::Clone for Struct_SwsVector {
    fn clone(&self) -> Struct_SwsVector { *self }
}
impl ::std::default::Default for Struct_SwsVector {
    fn default() -> Struct_SwsVector { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::clone::Clone for Struct_SwsFilter {
    fn clone(&self) -> Struct_SwsFilter { *self }
}
impl ::std::default::Default for Struct_SwsFilter {
    fn default() -> Struct_SwsFilter { unsafe { ::std::mem::zeroed() } }
}
...
pub const SWS_POINT: ::libc::c_int = 0x10;
pub const SWS_AREA: ::libc::c_int = 0x20;
pub const SWS_BICUBLIN: ::libc::c_int = 0x40;
pub const SWS_GAUSS: ::libc::c_int = 0x80;
pub const SWS_SINC: ::libc::c_int = 0x100;
pub const SWS_LANCZOS: ::libc::c_int = 0x200;
pub const SWS_SPLINE: ::libc::c_int = 0x400;
pub const SWS_SRC_V_CHR_DROP_MASK: ::libc::c_int = 0x30000;
pub const SWS_SRC_V_CHR_DROP_SHIFT: ::libc::c_int = 16;
pub const SWS_PARAM_DEFAULT: ::libc::c_int = 123456;
pub const SWS_PRINT_INFO: ::libc::c_int = 0x1000;
pub const SWS_FULL_CHR_H_INT: ::libc::c_int = 0x2000;
pub const SWS_FULL_CHR_H_INP: ::libc::c_int = 0x4000;
pub const SWS_DIRECT_BGR: ::libc::c_int = 0x8000;
pub const SWS_ACCURATE_RND: ::libc::c_int = 0x40000;
pub const SWS_BITEXACT: ::libc::c_int = 0x80000;
pub const SWS_MAX_REDUCE_CUTOFF: ::libc::c_float = 0.002;
...
pub fn version() -> u32 {
    unsafe { swscale_version() as u32 }
}

pub fn license() -> &'static str {
    std::str::from_utf8(unsafe { std::ffi::CStr::from_ptr(swscale_license()) }.to_bytes()).ok().expect("invalid utf8")
}
