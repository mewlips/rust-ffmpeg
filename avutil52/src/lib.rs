...
extern crate libc;
use libc::{c_int,size_t,uint8_t,int64_t,c_double,uint64_t,FILE,int8_t,uint32_t};
...
pub static AVMEDIA_TYPE_UNKNOWN: ::libc::c_int = -1;
pub static AVMEDIA_TYPE_VIDEO: ::libc::c_int = 0;
pub static AVMEDIA_TYPE_AUDIO: ::libc::c_int = 1;
pub static AVMEDIA_TYPE_DATA: ::libc::c_int = 2;
pub static AVMEDIA_TYPE_SUBTITLE: ::libc::c_int = 3;
pub static AVMEDIA_TYPE_ATTACHMENT: ::libc::c_int = 4;
pub static AVMEDIA_TYPE_NB: ::libc::c_int = 5;
pub type Enum_AVPictureType = ::libc::c_uint;
pub static AV_PICTURE_TYPE_NONE: ::libc::c_uint = 0;
pub static AV_PICTURE_TYPE_I: ::libc::c_uint = 1;
pub static AV_PICTURE_TYPE_P: ::libc::c_uint = 2;
pub static AV_PICTURE_TYPE_B: ::libc::c_uint = 3;
pub static AV_PICTURE_TYPE_S: ::libc::c_uint = 4;
pub static AV_PICTURE_TYPE_SI: ::libc::c_uint = 5;
pub static AV_PICTURE_TYPE_SP: ::libc::c_uint = 6;
pub static AV_PICTURE_TYPE_BI: ::libc::c_uint = 7;
#[deriving(Clone)]
#[repr(C)]
...
pub static AV_ROUND_ZERO: ::libc::c_uint = 0;
pub static AV_ROUND_INF: ::libc::c_uint = 1;
pub static AV_ROUND_DOWN: ::libc::c_uint = 2;
pub static AV_ROUND_UP: ::libc::c_uint = 3;
pub static AV_ROUND_NEAR_INF: ::libc::c_uint = 5;
pub static AV_ROUND_PASS_MINMAX: ::libc::c_uint = 8192;
pub type AVClassCategory = ::libc::c_uint;
pub static AV_CLASS_CATEGORY_NA: ::libc::c_uint = 0;
pub static AV_CLASS_CATEGORY_INPUT: ::libc::c_uint = 1;
pub static AV_CLASS_CATEGORY_OUTPUT: ::libc::c_uint = 2;
pub static AV_CLASS_CATEGORY_MUXER: ::libc::c_uint = 3;
pub static AV_CLASS_CATEGORY_DEMUXER: ::libc::c_uint = 4;
pub static AV_CLASS_CATEGORY_ENCODER: ::libc::c_uint = 5;
pub static AV_CLASS_CATEGORY_DECODER: ::libc::c_uint = 6;
pub static AV_CLASS_CATEGORY_FILTER: ::libc::c_uint = 7;
pub static AV_CLASS_CATEGORY_BITSTREAM_FILTER: ::libc::c_uint = 8;
pub static AV_CLASS_CATEGORY_SWSCALER: ::libc::c_uint = 9;
pub static AV_CLASS_CATEGORY_SWRESAMPLER: ::libc::c_uint = 10;
pub static AV_CLASS_CATEGORY_NB: ::libc::c_uint = 11;
#[repr(C)]
pub struct Struct_AVClass {
    pub class_name: *const ::libc::c_char,
    pub item_name: ::std::option::Option<extern "C" fn
    ...
    pub get_category: ::std::option::Option<extern "C" fn
                                                (arg1: *mut ::libc::c_void)
                                                -> AVClassCategory>,
...
pub static AV_PIX_FMT_NONE: ::libc::c_int = -1;
pub static AV_PIX_FMT_YUV420P: ::libc::c_int = 0;
pub static AV_PIX_FMT_YUYV422: ::libc::c_int = 1;
pub static AV_PIX_FMT_RGB24: ::libc::c_int = 2;
pub static AV_PIX_FMT_BGR24: ::libc::c_int = 3;
pub static AV_PIX_FMT_YUV422P: ::libc::c_int = 4;
pub static AV_PIX_FMT_YUV444P: ::libc::c_int = 5;
pub static AV_PIX_FMT_YUV410P: ::libc::c_int = 6;
pub static AV_PIX_FMT_YUV411P: ::libc::c_int = 7;
pub static AV_PIX_FMT_GRAY8: ::libc::c_int = 8;
pub static AV_PIX_FMT_MONOWHITE: ::libc::c_int = 9;
pub static AV_PIX_FMT_MONOBLACK: ::libc::c_int = 10;
pub static AV_PIX_FMT_PAL8: ::libc::c_int = 11;
pub static AV_PIX_FMT_YUVJ420P: ::libc::c_int = 12;
pub static AV_PIX_FMT_YUVJ422P: ::libc::c_int = 13;
pub static AV_PIX_FMT_YUVJ444P: ::libc::c_int = 14;
pub static AV_PIX_FMT_XVMC_MPEG2_MC: ::libc::c_int = 15;
pub static AV_PIX_FMT_XVMC_MPEG2_IDCT: ::libc::c_int = 16;
pub static AV_PIX_FMT_UYVY422: ::libc::c_int = 17;
pub static AV_PIX_FMT_UYYVYY411: ::libc::c_int = 18;
pub static AV_PIX_FMT_BGR8: ::libc::c_int = 19;
pub static AV_PIX_FMT_BGR4: ::libc::c_int = 20;
pub static AV_PIX_FMT_BGR4_BYTE: ::libc::c_int = 21;
pub static AV_PIX_FMT_RGB8: ::libc::c_int = 22;
pub static AV_PIX_FMT_RGB4: ::libc::c_int = 23;
pub static AV_PIX_FMT_RGB4_BYTE: ::libc::c_int = 24;
pub static AV_PIX_FMT_NV12: ::libc::c_int = 25;
pub static AV_PIX_FMT_NV21: ::libc::c_int = 26;
pub static AV_PIX_FMT_ARGB: ::libc::c_int = 27;
pub static AV_PIX_FMT_RGBA: ::libc::c_int = 28;
pub static AV_PIX_FMT_ABGR: ::libc::c_int = 29;
pub static AV_PIX_FMT_BGRA: ::libc::c_int = 30;
pub static AV_PIX_FMT_GRAY16BE: ::libc::c_int = 31;
pub static AV_PIX_FMT_GRAY16LE: ::libc::c_int = 32;
pub static AV_PIX_FMT_YUV440P: ::libc::c_int = 33;
pub static AV_PIX_FMT_YUVJ440P: ::libc::c_int = 34;
pub static AV_PIX_FMT_YUVA420P: ::libc::c_int = 35;
pub static AV_PIX_FMT_VDPAU_H264: ::libc::c_int = 36;
pub static AV_PIX_FMT_VDPAU_MPEG1: ::libc::c_int = 37;
pub static AV_PIX_FMT_VDPAU_MPEG2: ::libc::c_int = 38;
pub static AV_PIX_FMT_VDPAU_WMV3: ::libc::c_int = 39;
pub static AV_PIX_FMT_VDPAU_VC1: ::libc::c_int = 40;
pub static AV_PIX_FMT_RGB48BE: ::libc::c_int = 41;
pub static AV_PIX_FMT_RGB48LE: ::libc::c_int = 42;
pub static AV_PIX_FMT_RGB565BE: ::libc::c_int = 43;
pub static AV_PIX_FMT_RGB565LE: ::libc::c_int = 44;
pub static AV_PIX_FMT_RGB555BE: ::libc::c_int = 45;
pub static AV_PIX_FMT_RGB555LE: ::libc::c_int = 46;
pub static AV_PIX_FMT_BGR565BE: ::libc::c_int = 47;
pub static AV_PIX_FMT_BGR565LE: ::libc::c_int = 48;
pub static AV_PIX_FMT_BGR555BE: ::libc::c_int = 49;
pub static AV_PIX_FMT_BGR555LE: ::libc::c_int = 50;
pub static AV_PIX_FMT_VAAPI_MOCO: ::libc::c_int = 51;
pub static AV_PIX_FMT_VAAPI_IDCT: ::libc::c_int = 52;
pub static AV_PIX_FMT_VAAPI_VLD: ::libc::c_int = 53;
pub static AV_PIX_FMT_YUV420P16LE: ::libc::c_int = 54;
pub static AV_PIX_FMT_YUV420P16BE: ::libc::c_int = 55;
pub static AV_PIX_FMT_YUV422P16LE: ::libc::c_int = 56;
pub static AV_PIX_FMT_YUV422P16BE: ::libc::c_int = 57;
pub static AV_PIX_FMT_YUV444P16LE: ::libc::c_int = 58;
pub static AV_PIX_FMT_YUV444P16BE: ::libc::c_int = 59;
pub static AV_PIX_FMT_VDPAU_MPEG4: ::libc::c_int = 60;
pub static AV_PIX_FMT_DXVA2_VLD: ::libc::c_int = 61;
pub static AV_PIX_FMT_RGB444LE: ::libc::c_int = 62;
pub static AV_PIX_FMT_RGB444BE: ::libc::c_int = 63;
pub static AV_PIX_FMT_BGR444LE: ::libc::c_int = 64;
pub static AV_PIX_FMT_BGR444BE: ::libc::c_int = 65;
pub static AV_PIX_FMT_GRAY8A: ::libc::c_int = 66;
pub static AV_PIX_FMT_BGR48BE: ::libc::c_int = 67;
pub static AV_PIX_FMT_BGR48LE: ::libc::c_int = 68;
pub static AV_PIX_FMT_YUV420P9BE: ::libc::c_int = 69;
pub static AV_PIX_FMT_YUV420P9LE: ::libc::c_int = 70;
pub static AV_PIX_FMT_YUV420P10BE: ::libc::c_int = 71;
pub static AV_PIX_FMT_YUV420P10LE: ::libc::c_int = 72;
pub static AV_PIX_FMT_YUV422P10BE: ::libc::c_int = 73;
pub static AV_PIX_FMT_YUV422P10LE: ::libc::c_int = 74;
pub static AV_PIX_FMT_YUV444P9BE: ::libc::c_int = 75;
pub static AV_PIX_FMT_YUV444P9LE: ::libc::c_int = 76;
pub static AV_PIX_FMT_YUV444P10BE: ::libc::c_int = 77;
pub static AV_PIX_FMT_YUV444P10LE: ::libc::c_int = 78;
pub static AV_PIX_FMT_YUV422P9BE: ::libc::c_int = 79;
pub static AV_PIX_FMT_YUV422P9LE: ::libc::c_int = 80;
pub static AV_PIX_FMT_VDA_VLD: ::libc::c_int = 81;
pub static AV_PIX_FMT_GBRP: ::libc::c_int = 82;
pub static AV_PIX_FMT_GBRP9BE: ::libc::c_int = 83;
pub static AV_PIX_FMT_GBRP9LE: ::libc::c_int = 84;
pub static AV_PIX_FMT_GBRP10BE: ::libc::c_int = 85;
pub static AV_PIX_FMT_GBRP10LE: ::libc::c_int = 86;
pub static AV_PIX_FMT_GBRP16BE: ::libc::c_int = 87;
pub static AV_PIX_FMT_GBRP16LE: ::libc::c_int = 88;
pub static AV_PIX_FMT_YUVA422P_LIBAV: ::libc::c_int = 89;
pub static AV_PIX_FMT_YUVA444P_LIBAV: ::libc::c_int = 90;
pub static AV_PIX_FMT_YUVA420P9BE: ::libc::c_int = 91;
pub static AV_PIX_FMT_YUVA420P9LE: ::libc::c_int = 92;
pub static AV_PIX_FMT_YUVA422P9BE: ::libc::c_int = 93;
pub static AV_PIX_FMT_YUVA422P9LE: ::libc::c_int = 94;
pub static AV_PIX_FMT_YUVA444P9BE: ::libc::c_int = 95;
pub static AV_PIX_FMT_YUVA444P9LE: ::libc::c_int = 96;
pub static AV_PIX_FMT_YUVA420P10BE: ::libc::c_int = 97;
pub static AV_PIX_FMT_YUVA420P10LE: ::libc::c_int = 98;
pub static AV_PIX_FMT_YUVA422P10BE: ::libc::c_int = 99;
pub static AV_PIX_FMT_YUVA422P10LE: ::libc::c_int = 100;
pub static AV_PIX_FMT_YUVA444P10BE: ::libc::c_int = 101;
pub static AV_PIX_FMT_YUVA444P10LE: ::libc::c_int = 102;
pub static AV_PIX_FMT_YUVA420P16BE: ::libc::c_int = 103;
pub static AV_PIX_FMT_YUVA420P16LE: ::libc::c_int = 104;
pub static AV_PIX_FMT_YUVA422P16BE: ::libc::c_int = 105;
pub static AV_PIX_FMT_YUVA422P16LE: ::libc::c_int = 106;
pub static AV_PIX_FMT_YUVA444P16BE: ::libc::c_int = 107;
pub static AV_PIX_FMT_YUVA444P16LE: ::libc::c_int = 108;
pub static AV_PIX_FMT_VDPAU: ::libc::c_int = 109;
pub static AV_PIX_FMT_XYZ12LE: ::libc::c_int = 110;
pub static AV_PIX_FMT_XYZ12BE: ::libc::c_int = 111;
pub static AV_PIX_FMT_NV16: ::libc::c_int = 112;
pub static AV_PIX_FMT_NV20LE: ::libc::c_int = 113;
pub static AV_PIX_FMT_NV20BE: ::libc::c_int = 114;
pub static AV_PIX_FMT_RGBA64BE: ::libc::c_int = 291;
pub static AV_PIX_FMT_RGBA64LE: ::libc::c_int = 292;
pub static AV_PIX_FMT_BGRA64BE: ::libc::c_int = 293;
pub static AV_PIX_FMT_BGRA64LE: ::libc::c_int = 294;
pub static AV_PIX_FMT_0RGB: ::libc::c_int = 295;
pub static AV_PIX_FMT_RGB0: ::libc::c_int = 296;
pub static AV_PIX_FMT_0BGR: ::libc::c_int = 297;
pub static AV_PIX_FMT_BGR0: ::libc::c_int = 298;
pub static AV_PIX_FMT_YUVA444P: ::libc::c_int = 299;
pub static AV_PIX_FMT_YUVA422P: ::libc::c_int = 300;
pub static AV_PIX_FMT_YUV420P12BE: ::libc::c_int = 301;
pub static AV_PIX_FMT_YUV420P12LE: ::libc::c_int = 302;
pub static AV_PIX_FMT_YUV420P14BE: ::libc::c_int = 303;
pub static AV_PIX_FMT_YUV420P14LE: ::libc::c_int = 304;
pub static AV_PIX_FMT_YUV422P12BE: ::libc::c_int = 305;
pub static AV_PIX_FMT_YUV422P12LE: ::libc::c_int = 306;
pub static AV_PIX_FMT_YUV422P14BE: ::libc::c_int = 307;
pub static AV_PIX_FMT_YUV422P14LE: ::libc::c_int = 308;
pub static AV_PIX_FMT_YUV444P12BE: ::libc::c_int = 309;
pub static AV_PIX_FMT_YUV444P12LE: ::libc::c_int = 310;
pub static AV_PIX_FMT_YUV444P14BE: ::libc::c_int = 311;
pub static AV_PIX_FMT_YUV444P14LE: ::libc::c_int = 312;
pub static AV_PIX_FMT_GBRP12BE: ::libc::c_int = 313;
pub static AV_PIX_FMT_GBRP12LE: ::libc::c_int = 314;
pub static AV_PIX_FMT_GBRP14BE: ::libc::c_int = 315;
pub static AV_PIX_FMT_GBRP14LE: ::libc::c_int = 316;
pub static AV_PIX_FMT_GBRAP: ::libc::c_int = 317;
pub static AV_PIX_FMT_GBRAP16BE: ::libc::c_int = 318;
pub static AV_PIX_FMT_GBRAP16LE: ::libc::c_int = 319;
pub static AV_PIX_FMT_YUVJ411P: ::libc::c_int = 320;
pub static AV_PIX_FMT_BAYER_BGGR8: ::libc::c_int = 321;
pub static AV_PIX_FMT_BAYER_RGGB8: ::libc::c_int = 322;
pub static AV_PIX_FMT_BAYER_GBRG8: ::libc::c_int = 323;
pub static AV_PIX_FMT_BAYER_GRBG8: ::libc::c_int = 324;
pub static AV_PIX_FMT_BAYER_BGGR16LE: ::libc::c_int = 325;
pub static AV_PIX_FMT_BAYER_BGGR16BE: ::libc::c_int = 326;
pub static AV_PIX_FMT_BAYER_RGGB16LE: ::libc::c_int = 327;
pub static AV_PIX_FMT_BAYER_RGGB16BE: ::libc::c_int = 328;
pub static AV_PIX_FMT_BAYER_GBRG16LE: ::libc::c_int = 329;
pub static AV_PIX_FMT_BAYER_GBRG16BE: ::libc::c_int = 330;
pub static AV_PIX_FMT_BAYER_GRBG16LE: ::libc::c_int = 331;
pub static AV_PIX_FMT_BAYER_GRBG16BE: ::libc::c_int = 332;
pub static AV_PIX_FMT_NB: ::libc::c_int = 333;
pub static PIX_FMT_NONE: ::libc::c_int = -1;
pub static PIX_FMT_YUV420P: ::libc::c_int = 0;
pub static PIX_FMT_YUYV422: ::libc::c_int = 1;
pub static PIX_FMT_RGB24: ::libc::c_int = 2;
pub static PIX_FMT_BGR24: ::libc::c_int = 3;
pub static PIX_FMT_YUV422P: ::libc::c_int = 4;
pub static PIX_FMT_YUV444P: ::libc::c_int = 5;
pub static PIX_FMT_YUV410P: ::libc::c_int = 6;
pub static PIX_FMT_YUV411P: ::libc::c_int = 7;
pub static PIX_FMT_GRAY8: ::libc::c_int = 8;
pub static PIX_FMT_MONOWHITE: ::libc::c_int = 9;
pub static PIX_FMT_MONOBLACK: ::libc::c_int = 10;
pub static PIX_FMT_PAL8: ::libc::c_int = 11;
pub static PIX_FMT_YUVJ420P: ::libc::c_int = 12;
pub static PIX_FMT_YUVJ422P: ::libc::c_int = 13;
pub static PIX_FMT_YUVJ444P: ::libc::c_int = 14;
pub static PIX_FMT_XVMC_MPEG2_MC: ::libc::c_int = 15;
pub static PIX_FMT_XVMC_MPEG2_IDCT: ::libc::c_int = 16;
pub static PIX_FMT_UYVY422: ::libc::c_int = 17;
pub static PIX_FMT_UYYVYY411: ::libc::c_int = 18;
pub static PIX_FMT_BGR8: ::libc::c_int = 19;
pub static PIX_FMT_BGR4: ::libc::c_int = 20;
pub static PIX_FMT_BGR4_BYTE: ::libc::c_int = 21;
pub static PIX_FMT_RGB8: ::libc::c_int = 22;
pub static PIX_FMT_RGB4: ::libc::c_int = 23;
pub static PIX_FMT_RGB4_BYTE: ::libc::c_int = 24;
pub static PIX_FMT_NV12: ::libc::c_int = 25;
pub static PIX_FMT_NV21: ::libc::c_int = 26;
pub static PIX_FMT_ARGB: ::libc::c_int = 27;
pub static PIX_FMT_RGBA: ::libc::c_int = 28;
pub static PIX_FMT_ABGR: ::libc::c_int = 29;
pub static PIX_FMT_BGRA: ::libc::c_int = 30;
pub static PIX_FMT_GRAY16BE: ::libc::c_int = 31;
pub static PIX_FMT_GRAY16LE: ::libc::c_int = 32;
pub static PIX_FMT_YUV440P: ::libc::c_int = 33;
pub static PIX_FMT_YUVJ440P: ::libc::c_int = 34;
pub static PIX_FMT_YUVA420P: ::libc::c_int = 35;
pub static PIX_FMT_VDPAU_H264: ::libc::c_int = 36;
pub static PIX_FMT_VDPAU_MPEG1: ::libc::c_int = 37;
pub static PIX_FMT_VDPAU_MPEG2: ::libc::c_int = 38;
pub static PIX_FMT_VDPAU_WMV3: ::libc::c_int = 39;
pub static PIX_FMT_VDPAU_VC1: ::libc::c_int = 40;
pub static PIX_FMT_RGB48BE: ::libc::c_int = 41;
pub static PIX_FMT_RGB48LE: ::libc::c_int = 42;
pub static PIX_FMT_RGB565BE: ::libc::c_int = 43;
pub static PIX_FMT_RGB565LE: ::libc::c_int = 44;
pub static PIX_FMT_RGB555BE: ::libc::c_int = 45;
pub static PIX_FMT_RGB555LE: ::libc::c_int = 46;
pub static PIX_FMT_BGR565BE: ::libc::c_int = 47;
pub static PIX_FMT_BGR565LE: ::libc::c_int = 48;
pub static PIX_FMT_BGR555BE: ::libc::c_int = 49;
pub static PIX_FMT_BGR555LE: ::libc::c_int = 50;
pub static PIX_FMT_VAAPI_MOCO: ::libc::c_int = 51;
pub static PIX_FMT_VAAPI_IDCT: ::libc::c_int = 52;
pub static PIX_FMT_VAAPI_VLD: ::libc::c_int = 53;
pub static PIX_FMT_YUV420P16LE: ::libc::c_int = 54;
pub static PIX_FMT_YUV420P16BE: ::libc::c_int = 55;
pub static PIX_FMT_YUV422P16LE: ::libc::c_int = 56;
pub static PIX_FMT_YUV422P16BE: ::libc::c_int = 57;
pub static PIX_FMT_YUV444P16LE: ::libc::c_int = 58;
pub static PIX_FMT_YUV444P16BE: ::libc::c_int = 59;
pub static PIX_FMT_VDPAU_MPEG4: ::libc::c_int = 60;
pub static PIX_FMT_DXVA2_VLD: ::libc::c_int = 61;
pub static PIX_FMT_RGB444LE: ::libc::c_int = 62;
pub static PIX_FMT_RGB444BE: ::libc::c_int = 63;
pub static PIX_FMT_BGR444LE: ::libc::c_int = 64;
pub static PIX_FMT_BGR444BE: ::libc::c_int = 65;
pub static PIX_FMT_GRAY8A: ::libc::c_int = 66;
pub static PIX_FMT_BGR48BE: ::libc::c_int = 67;
pub static PIX_FMT_BGR48LE: ::libc::c_int = 68;
pub static PIX_FMT_YUV420P9BE: ::libc::c_int = 69;
pub static PIX_FMT_YUV420P9LE: ::libc::c_int = 70;
pub static PIX_FMT_YUV420P10BE: ::libc::c_int = 71;
pub static PIX_FMT_YUV420P10LE: ::libc::c_int = 72;
pub static PIX_FMT_YUV422P10BE: ::libc::c_int = 73;
pub static PIX_FMT_YUV422P10LE: ::libc::c_int = 74;
pub static PIX_FMT_YUV444P9BE: ::libc::c_int = 75;
pub static PIX_FMT_YUV444P9LE: ::libc::c_int = 76;
pub static PIX_FMT_YUV444P10BE: ::libc::c_int = 77;
pub static PIX_FMT_YUV444P10LE: ::libc::c_int = 78;
pub static PIX_FMT_YUV422P9BE: ::libc::c_int = 79;
pub static PIX_FMT_YUV422P9LE: ::libc::c_int = 80;
pub static PIX_FMT_VDA_VLD: ::libc::c_int = 81;
pub static PIX_FMT_GBRP: ::libc::c_int = 82;
pub static PIX_FMT_GBRP9BE: ::libc::c_int = 83;
pub static PIX_FMT_GBRP9LE: ::libc::c_int = 84;
pub static PIX_FMT_GBRP10BE: ::libc::c_int = 85;
pub static PIX_FMT_GBRP10LE: ::libc::c_int = 86;
pub static PIX_FMT_GBRP16BE: ::libc::c_int = 87;
pub static PIX_FMT_GBRP16LE: ::libc::c_int = 88;
pub static PIX_FMT_RGBA64BE: ::libc::c_int = 291;
pub static PIX_FMT_RGBA64LE: ::libc::c_int = 292;
pub static PIX_FMT_BGRA64BE: ::libc::c_int = 293;
pub static PIX_FMT_BGRA64LE: ::libc::c_int = 294;
pub static PIX_FMT_0RGB: ::libc::c_int = 295;
pub static PIX_FMT_RGB0: ::libc::c_int = 296;
pub static PIX_FMT_0BGR: ::libc::c_int = 297;
pub static PIX_FMT_BGR0: ::libc::c_int = 298;
pub static PIX_FMT_YUVA444P: ::libc::c_int = 299;
pub static PIX_FMT_YUVA422P: ::libc::c_int = 300;
pub static PIX_FMT_YUV420P12BE: ::libc::c_int = 301;
pub static PIX_FMT_YUV420P12LE: ::libc::c_int = 302;
pub static PIX_FMT_YUV420P14BE: ::libc::c_int = 303;
pub static PIX_FMT_YUV420P14LE: ::libc::c_int = 304;
pub static PIX_FMT_YUV422P12BE: ::libc::c_int = 305;
pub static PIX_FMT_YUV422P12LE: ::libc::c_int = 306;
pub static PIX_FMT_YUV422P14BE: ::libc::c_int = 307;
pub static PIX_FMT_YUV422P14LE: ::libc::c_int = 308;
pub static PIX_FMT_YUV444P12BE: ::libc::c_int = 309;
pub static PIX_FMT_YUV444P12LE: ::libc::c_int = 310;
pub static PIX_FMT_YUV444P14BE: ::libc::c_int = 311;
pub static PIX_FMT_YUV444P14LE: ::libc::c_int = 312;
pub static PIX_FMT_GBRP12BE: ::libc::c_int = 313;
pub static PIX_FMT_GBRP12LE: ::libc::c_int = 314;
pub static PIX_FMT_GBRP14BE: ::libc::c_int = 315;
pub static PIX_FMT_GBRP14LE: ::libc::c_int = 316;
pub static PIX_FMT_NB: ::libc::c_int = 317;
pub type Enum_AVSampleFormat = ::libc::c_int;
pub static AV_SAMPLE_FMT_NONE: ::libc::c_int = -1;
pub static AV_SAMPLE_FMT_U8: ::libc::c_int = 0;
pub static AV_SAMPLE_FMT_S16: ::libc::c_int = 1;
pub static AV_SAMPLE_FMT_S32: ::libc::c_int = 2;
pub static AV_SAMPLE_FMT_FLT: ::libc::c_int = 3;
pub static AV_SAMPLE_FMT_DBL: ::libc::c_int = 4;
pub static AV_SAMPLE_FMT_U8P: ::libc::c_int = 5;
pub static AV_SAMPLE_FMT_S16P: ::libc::c_int = 6;
pub static AV_SAMPLE_FMT_S32P: ::libc::c_int = 7;
pub static AV_SAMPLE_FMT_FLTP: ::libc::c_int = 8;
pub static AV_SAMPLE_FMT_DBLP: ::libc::c_int = 9;
pub static AV_SAMPLE_FMT_NB: ::libc::c_int = 10;
#[repr(C)]
...
pub static AV_MATRIX_ENCODING_NONE: ::libc::c_uint = 0;
pub static AV_MATRIX_ENCODING_DOLBY: ::libc::c_uint = 1;
pub static AV_MATRIX_ENCODING_DPLII: ::libc::c_uint = 2;
pub static AV_MATRIX_ENCODING_DPLIIX: ::libc::c_uint = 3;
pub static AV_MATRIX_ENCODING_DPLIIZ: ::libc::c_uint = 4;
pub static AV_MATRIX_ENCODING_DOLBYEX: ::libc::c_uint = 5;
pub static AV_MATRIX_ENCODING_DOLBYHEADPHONE: ::libc::c_uint = 6;
pub static AV_MATRIX_ENCODING_NB: ::libc::c_uint = 7;
pub enum Struct_AVBPrint { }
pub type Enum_AVOptionType = ::libc::c_uint;
pub static AV_OPT_TYPE_FLAGS: ::libc::c_uint = 0;
pub static AV_OPT_TYPE_INT: ::libc::c_uint = 1;
pub static AV_OPT_TYPE_INT64: ::libc::c_uint = 2;
pub static AV_OPT_TYPE_DOUBLE: ::libc::c_uint = 3;
pub static AV_OPT_TYPE_FLOAT: ::libc::c_uint = 4;
pub static AV_OPT_TYPE_STRING: ::libc::c_uint = 5;
pub static AV_OPT_TYPE_RATIONAL: ::libc::c_uint = 6;
pub static AV_OPT_TYPE_BINARY: ::libc::c_uint = 7;
pub static AV_OPT_TYPE_CONST: ::libc::c_uint = 128;
pub static AV_OPT_TYPE_IMAGE_SIZE: ::libc::c_uint = 1397316165;
pub static AV_OPT_TYPE_PIXEL_FMT: ::libc::c_uint = 1346784596;
pub static AV_OPT_TYPE_SAMPLE_FMT: ::libc::c_uint = 1397116244;
pub static AV_OPT_TYPE_VIDEO_RATE: ::libc::c_uint = 1448231252;
pub static AV_OPT_TYPE_DURATION: ::libc::c_uint = 1146442272;
pub static AV_OPT_TYPE_COLOR: ::libc::c_uint = 1129270354;
pub static AV_OPT_TYPE_CHANNEL_LAYOUT: ::libc::c_uint = 1128811585;
pub static FF_OPT_TYPE_FLAGS: ::libc::c_uint = 0;
pub static FF_OPT_TYPE_INT: ::libc::c_uint = 1;
pub static FF_OPT_TYPE_INT64: ::libc::c_uint = 2;
pub static FF_OPT_TYPE_DOUBLE: ::libc::c_uint = 3;
pub static FF_OPT_TYPE_FLOAT: ::libc::c_uint = 4;
pub static FF_OPT_TYPE_STRING: ::libc::c_uint = 5;
pub static FF_OPT_TYPE_RATIONAL: ::libc::c_uint = 6;
pub static FF_OPT_TYPE_BINARY: ::libc::c_uint = 7;
pub static FF_OPT_TYPE_CONST: ::libc::c_uint = 128;
#[repr(C)]
...
impl Union_Unnamed1 {
    ...
    pub fn str(&mut self) -> *mut *const ::libc::c_char {
        unsafe { ::std::mem::transmute(self) }
    }
...
pub static AV_OPT_FLAG_IMPLICIT_KEY: ::libc::c_uint = 1;
...
pub static AVCOL_SPC_RGB: ::libc::c_uint = 0;
pub static AVCOL_SPC_BT709: ::libc::c_uint = 1;
pub static AVCOL_SPC_UNSPECIFIED: ::libc::c_uint = 2;
pub static AVCOL_SPC_FCC: ::libc::c_uint = 4;
pub static AVCOL_SPC_BT470BG: ::libc::c_uint = 5;
pub static AVCOL_SPC_SMPTE170M: ::libc::c_uint = 6;
pub static AVCOL_SPC_SMPTE240M: ::libc::c_uint = 7;
pub static AVCOL_SPC_YCOCG: ::libc::c_uint = 8;
pub static AVCOL_SPC_BT2020_NCL: ::libc::c_uint = 9;
pub static AVCOL_SPC_BT2020_CL: ::libc::c_uint = 10;
pub static AVCOL_SPC_NB: ::libc::c_uint = 11;
pub type Enum_AVColorRange = ::libc::c_uint;
pub static AVCOL_RANGE_UNSPECIFIED: ::libc::c_uint = 0;
pub static AVCOL_RANGE_MPEG: ::libc::c_uint = 1;
pub static AVCOL_RANGE_JPEG: ::libc::c_uint = 2;
pub static AVCOL_RANGE_NB: ::libc::c_uint = 3;
pub type Enum_AVFrameSideDataType = ::libc::c_uint;
pub static AV_FRAME_DATA_PANSCAN: ::libc::c_uint = 0;
pub static AV_FRAME_DATA_A53_CC: ::libc::c_uint = 1;
pub static AV_FRAME_DATA_STEREO3D: ::libc::c_uint = 2;
pub static AV_FRAME_DATA_MATRIXENCODING: ::libc::c_uint = 3;
pub static AV_FRAME_DATA_DOWNMIX_INFO: ::libc::c_uint = 4;
#[repr(C)]
...
pub struct Struct_AVFrame {
    ...
    pub motion_val: [*mut ::libc::c_void, ..2u],
