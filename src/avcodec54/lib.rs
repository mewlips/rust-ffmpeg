...
pub struct Struct_AVCodecContext {
    ...
    pub codec_type: avutil52::Enum_AVMediaType,
    ...
    pub gop_size: c_int,
    pub pix_fmt: avutil52::Enum_AVPixelFormat,
    pub me_method: c_int,
    ...
    pub get_format: ::std::option::Option<extern "C" fn
                                              (arg1:
                                                   *mut Struct_AVCodecContext,
                                               arg2: *avutil52::Enum_AVPixelFormat)
    ...
    pub sample_rate: c_int,
    pub channels: c_int,
    pub sample_fmt: avutil52::Enum_AVSampleFormat,
    ...
    pub request_sample_fmt: avutil52::Enum_AVSampleFormat,
    ...
    pub pkt_timebase: avutil52::AVRational,
...
pub struct Struct_AVCodec {
    ...
    pub supported_framerates: *avutil52::AVRational,
    pub pix_fmts: *avutil52::Enum_AVPixelFormat,
    pub supported_samplerates: *c_int,
    pub sample_fmts: *avutil52::Enum_AVSampleFormat,
...
extern "C" {
    ...
    pub fn av_frame_get_metadata(frame: *AVFrame) -> *mut avutil52::AVDictionary;
    pub fn av_frame_set_metadata(frame: *mut AVFrame, val: *mut avutil52::AVDictionary);
    ...
    pub fn av_codec_get_pkt_timebase(avctx: *AVCodecContext) -> avutil52::AVRational;
    pub fn av_codec_set_pkt_timebase(avctx: *mut AVCodecContext,
                                     val: avutil52::AVRational);
    ...
    pub fn avcodec_alloc_context2(arg1: avutil52::Enum_AVMediaType) ->
     *mut AVCodecContext;
    pub fn avcodec_get_context_defaults(s: *mut AVCodecContext);
    pub fn avcodec_get_context_defaults2(s: *mut AVCodecContext,
                                         arg1: avutil52::Enum_AVMediaType);
    pub fn avcodec_alloc_context3(codec: *AVCodec) -> *mut AVCodecContext;
    pub fn avcodec_get_context_defaults3(s: *mut AVCodecContext,
                                         codec: *AVCodec) -> c_int;
    pub fn avcodec_get_class() -> *avutil52::AVClass;
    pub fn avcodec_get_frame_class() -> *avutil52::AVClass;
    pub fn avcodec_get_subtitle_rect_class() -> *avutil52::AVClass;
    ...
    pub fn av_audio_resample_init(output_channels: c_int,
                                  ...
                                  input_rate: c_int,
                                  sample_fmt_out: avutil52::Enum_AVSampleFormat,
                                  sample_fmt_in: avutil52::Enum_AVSampleFormat,
                                  filter_length: c_int,
    ...
    pub fn avpicture_alloc(picture: *mut AVPicture,
                           pix_fmt: avutil52::Enum_AVPixelFormat, width: c_int,
                           height: c_int) -> c_int;
    pub fn avpicture_free(picture: *mut AVPicture);
    pub fn avpicture_fill(picture: *mut AVPicture, ptr: *uint8_t,
                          pix_fmt: avutil52::Enum_AVPixelFormat, width: c_int,
                          height: c_int) -> c_int;
    pub fn avpicture_layout(src: *AVPicture, pix_fmt: avutil52::Enum_AVPixelFormat,
                            width: c_int, height: c_int, dest: *mut c_uchar,
                            dest_size: c_int) -> c_int;
    pub fn avpicture_get_size(pix_fmt: avutil52::Enum_AVPixelFormat, width: c_int,
                              height: c_int) -> c_int;
    ...
    pub fn av_picture_crop(dst: *mut AVPicture, src: *AVPicture,
                           pix_fmt: avutil52::Enum_AVPixelFormat, top_band: c_int,
                           left_band: c_int) -> c_int;
    pub fn av_picture_pad(dst: *mut AVPicture, src: *AVPicture, height: c_int,
                          width: c_int, pix_fmt: avutil52::Enum_AVPixelFormat,
                          padtop: c_int, padbottom: c_int, padleft: c_int,
                          padright: c_int, color: *mut c_int) -> c_int;
    pub fn avcodec_get_chroma_sub_sample(pix_fmt: avutil52::Enum_AVPixelFormat,
                                         h_shift: *mut c_int,
                                         v_shift: *mut c_int);
    pub fn avcodec_pix_fmt_to_codec_tag(pix_fmt: avutil52::Enum_AVPixelFormat) ->
     c_uint;
    pub fn avcodec_get_pix_fmt_loss(dst_pix_fmt: avutil52::Enum_AVPixelFormat,
                                    src_pix_fmt: avutil52::Enum_AVPixelFormat,
    ...
    pub fn avcodec_find_best_pix_fmt_of_list(pix_fmt_list:
                                                 *mut avutil52::Enum_AVPixelFormat,
                                             src_pix_fmt: avutil52::Enum_AVPixelFormat,
                                             has_alpha: c_int,
                                             loss_ptr: *mut c_int) ->
     avutil52::Enum_AVPixelFormat;
    pub fn avcodec_find_best_pix_fmt_of_2(dst_pix_fmt1: avutil52::Enum_AVPixelFormat,
                                          dst_pix_fmt2: avutil52::Enum_AVPixelFormat,
                                          src_pix_fmt: avutil52::Enum_AVPixelFormat,
                                          has_alpha: c_int,
                                          loss_ptr: *mut c_int) ->
     avutil52::Enum_AVPixelFormat;
    pub fn avcodec_find_best_pix_fmt2(dst_pix_fmt1: avutil52::Enum_AVPixelFormat,
                                      dst_pix_fmt2: avutil52::Enum_AVPixelFormat,
                                      src_pix_fmt: avutil52::Enum_AVPixelFormat,
                                      has_alpha: c_int, loss_ptr: *mut c_int)
     -> avutil52::Enum_AVPixelFormat;
    pub fn avcodec_default_get_format(s: *mut Struct_AVCodecContext,
                                      fmt: *avutil52::Enum_AVPixelFormat) ->
     avutil52::Enum_AVPixelFormat;
    ...
    pub fn avcodec_fill_audio_frame(frame: *mut AVFrame, nb_channels: c_int,
                                    sample_fmt: avutil52::Enum_AVSampleFormat,
    ...
    pub fn av_get_pcm_codec(fmt: avutil52::Enum_AVSampleFormat, _be: c_int) ->
     Enum_AVCodecID;
    ...
    pub fn av_lockmgr_register(cb:
                                   ::std::option::Option<extern "C" fn
                                                             ...
                                                             -> c_int>) ->
     c_int;
    pub fn avcodec_get_type(codec_id: Enum_AVCodecID) -> avutil52::Enum_AVMediaType;
