#[link(name = "avcodec", vers = "54.92.100")];
#[license = "MIT"];
#[crate_type = "lib"];
...
externfn!(fn av_frame_get_best_effort_timestamp(frame: *AVFrame) -> int64_t)
externfn!(fn av_frame_set_best_effort_timestamp(frame: *mut AVFrame,
                                              val: int64_t))
externfn!(fn av_frame_get_pkt_duration(frame: *AVFrame) -> int64_t)
externfn!(fn av_frame_set_pkt_duration(frame: *mut AVFrame, val: int64_t))
externfn!(fn av_frame_get_pkt_pos(frame: *AVFrame) -> int64_t)
externfn!(fn av_frame_set_pkt_pos(frame: *mut AVFrame, val: int64_t))
externfn!(fn av_frame_get_channel_layout(frame: *AVFrame) -> int64_t)
externfn!(fn av_frame_set_channel_layout(frame: *mut AVFrame, val: int64_t))
externfn!(fn av_frame_get_channels(frame: *AVFrame) -> c_int)
externfn!(fn av_frame_set_channels(frame: *mut AVFrame, val: c_int))
externfn!(fn av_frame_get_sample_rate(frame: *AVFrame) -> c_int)
externfn!(fn av_frame_set_sample_rate(frame: *mut AVFrame, val: c_int))
externfn!(fn av_frame_get_metadata(frame: *AVFrame) -> *mut avutil::AVDictionary)
externfn!(fn av_frame_set_metadata(frame: *mut AVFrame, val: *mut avutil::AVDictionary))
externfn!(fn av_frame_get_decode_error_flags(frame: *AVFrame) -> c_int)
externfn!(fn av_frame_set_decode_error_flags(frame: *mut AVFrame, val: c_int))
externfn!(fn av_frame_get_pkt_size(frame: *AVFrame) -> c_int)
externfn!(fn av_frame_set_pkt_size(frame: *mut AVFrame, val: c_int))
externfn!(fn av_codec_get_pkt_timebase(avctx: *AVCodecContext) -> avutil::AVRational)
externfn!(fn av_codec_set_pkt_timebase(avctx: *mut AVCodecContext,
                                     val: avutil::AVRational))
externfn!(fn av_codec_get_codec_descriptor(avctx: *AVCodecContext) ->
     *AVCodecDescriptor)
externfn!(fn av_codec_set_codec_descriptor(avctx: *mut AVCodecContext,
                                         desc: *AVCodecDescriptor))
externfn!(fn av_codec_next(c: *AVCodec) -> *mut AVCodec)
externfn!(fn avcodec_version() -> c_uint)
externfn!(fn avcodec_configuration() -> *c_schar)
externfn!(fn avcodec_license() -> *c_schar)
externfn!(fn avcodec_register(codec: *mut AVCodec))
externfn!(fn avcodec_register_all())
externfn!(fn avcodec_alloc_context() -> *mut AVCodecContext)
externfn!(fn avcodec_alloc_context2(arg1: avutil::Enum_AVMediaType) ->
     *mut AVCodecContext)
externfn!(fn avcodec_get_context_defaults(s: *mut AVCodecContext))
externfn!(fn avcodec_get_context_defaults2(s: *mut AVCodecContext,
                                         arg1: avutil::Enum_AVMediaType))
externfn!(fn avcodec_alloc_context3(codec: *AVCodec) -> *mut AVCodecContext)
externfn!(fn avcodec_get_context_defaults3(s: *mut AVCodecContext,
                                         codec: *AVCodec) -> c_int)
externfn!(fn avcodec_get_class() -> *avutil::AVClass)
externfn!(fn avcodec_get_frame_class() -> *avutil::AVClass)
externfn!(fn avcodec_get_subtitle_rect_class() -> *avutil::AVClass)
externfn!(fn avcodec_copy_context(dest: *mut AVCodecContext,
                                src: *AVCodecContext) -> c_int)
externfn!(fn avcodec_alloc_frame() -> *mut AVFrame)
externfn!(fn avcodec_get_frame_defaults(frame: *mut AVFrame))
externfn!(fn avcodec_free_frame(frame: *mut *mut AVFrame))
externfn!(fn avcodec_open(avctx: *mut AVCodecContext, codec: *mut AVCodec) ->
     c_int)
externfn!(fn avcodec_open2(avctx: *mut AVCodecContext, codec: *AVCodec,
                         options: *mut *mut avutil::AVDictionary) -> c_int)
externfn!(fn avcodec_close(avctx: *mut AVCodecContext) -> c_int)
externfn!(fn avsubtitle_free(sub: *mut AVSubtitle))
externfn!(fn av_destruct_packet(pkt: *mut AVPacket))
externfn!(fn av_init_packet(pkt: *mut AVPacket))
externfn!(fn av_new_packet(pkt: *mut AVPacket, size: c_int) -> c_int)
externfn!(fn av_shrink_packet(pkt: *mut AVPacket, size: c_int))
externfn!(fn av_grow_packet(pkt: *mut AVPacket, grow_by: c_int) -> c_int)
externfn!(fn av_dup_packet(pkt: *mut AVPacket) -> c_int)
externfn!(fn av_copy_packet(dst: *mut AVPacket, src: *mut AVPacket) -> c_int)
externfn!(fn av_free_packet(pkt: *mut AVPacket))
externfn!(fn av_packet_new_side_data(pkt: *mut AVPacket,
                                   _type: Enum_AVPacketSideDataType,
                                   size: c_int) -> *mut uint8_t)
externfn!(fn av_packet_shrink_side_data(pkt: *mut AVPacket,
                                      _type: Enum_AVPacketSideDataType,
                                      size: c_int) -> c_int)
externfn!(fn av_packet_get_side_data(pkt: *mut AVPacket,
                                   _type: Enum_AVPacketSideDataType,
                                   size: *mut c_int) -> *mut uint8_t)
externfn!(fn av_packet_merge_side_data(pkt: *mut AVPacket) -> c_int)
externfn!(fn av_packet_split_side_data(pkt: *mut AVPacket) -> c_int)
externfn!(fn avcodec_find_decoder(id: Enum_AVCodecID) -> *mut AVCodec)
externfn!(fn avcodec_find_decoder_by_name(name: *c_schar) -> *mut AVCodec)
externfn!(fn avcodec_default_get_buffer(s: *mut AVCodecContext,
                                      pic: *mut AVFrame) -> c_int)
externfn!(fn avcodec_default_release_buffer(s: *mut AVCodecContext,
                                          pic: *mut AVFrame))
externfn!(fn avcodec_default_reget_buffer(s: *mut AVCodecContext,
                                        pic: *mut AVFrame) -> c_int)
externfn!(fn avcodec_get_edge_width() -> c_uint)
externfn!(fn avcodec_align_dimensions(s: *mut AVCodecContext, width: *mut c_int,
                                    height: *mut c_int))
externfn!(fn avcodec_align_dimensions2(s: *mut AVCodecContext,
                                     width: *mut c_int, height: *mut c_int,
                                     linesize_align: [c_int, ..8u]))
externfn!(fn avcodec_decode_audio3(avctx: *mut AVCodecContext,
                                 samples: *mut int16_t,
                                 frame_size_ptr: *mut c_int,
                                 avpkt: *mut AVPacket) -> c_int)
externfn!(fn avcodec_decode_audio4(avctx: *mut AVCodecContext,
                                 frame: *mut AVFrame,
                                 got_frame_ptr: *mut c_int, avpkt: *AVPacket)
     -> c_int)
externfn!(fn avcodec_decode_video2(avctx: *mut AVCodecContext,
                                 picture: *mut AVFrame,
                                 got_picture_ptr: *mut c_int,
                                 avpkt: *AVPacket) -> c_int)
externfn!(fn avcodec_decode_subtitle2(avctx: *mut AVCodecContext,
                                    sub: *mut AVSubtitle,
                                    got_sub_ptr: *mut c_int,
                                    avpkt: *mut AVPacket) -> c_int)
externfn!(fn av_parser_next(c: *mut AVCodecParser) -> *mut AVCodecParser)
externfn!(fn av_register_codec_parser(parser: *mut AVCodecParser))
externfn!(fn av_parser_init(codec_id: c_int) -> *mut AVCodecParserContext)
externfn!(fn av_parser_parse2(s: *mut AVCodecParserContext,
                            avctx: *mut AVCodecContext,
                            poutbuf: *mut *mut uint8_t,
                            poutbuf_size: *mut c_int, buf: *uint8_t,
                            buf_size: c_int, pts: int64_t, dts: int64_t,
                            pos: int64_t) -> c_int)
externfn!(fn av_parser_change(s: *mut AVCodecParserContext,
                            avctx: *mut AVCodecContext,
                            poutbuf: *mut *mut uint8_t,
                            poutbuf_size: *mut c_int, buf: *uint8_t,
                            buf_size: c_int, keyframe: c_int) -> c_int)
externfn!(fn av_parser_close(s: *mut AVCodecParserContext))
externfn!(fn avcodec_find_encoder(id: Enum_AVCodecID) -> *mut AVCodec)
externfn!(fn avcodec_find_encoder_by_name(name: *c_schar) -> *mut AVCodec)
externfn!(fn avcodec_encode_audio(avctx: *mut AVCodecContext, buf: *mut uint8_t,
                                buf_size: c_int, samples: *c_short) -> c_int)
externfn!(fn avcodec_encode_audio2(avctx: *mut AVCodecContext,
                                 avpkt: *mut AVPacket, frame: *AVFrame,
                                 got_packet_ptr: *mut c_int) -> c_int)
externfn!(fn avcodec_encode_video(avctx: *mut AVCodecContext, buf: *mut uint8_t,
                                buf_size: c_int, pict: *AVFrame) -> c_int)
externfn!(fn avcodec_encode_video2(avctx: *mut AVCodecContext,
                                 avpkt: *mut AVPacket, frame: *AVFrame,
                                 got_packet_ptr: *mut c_int) -> c_int)
externfn!(fn avcodec_encode_subtitle(avctx: *mut AVCodecContext,
                                   buf: *mut uint8_t, buf_size: c_int,
                                   sub: *AVSubtitle) -> c_int)
externfn!(fn av_audio_resample_init(output_channels: c_int,
...
externfn!(fn audio_resample(s: *mut ReSampleContext, output: *mut c_short,
                          input: *mut c_short, nb_samples: c_int) -> c_int)
externfn!(fn audio_resample_close(s: *mut ReSampleContext))
externfn!(fn av_resample_init(out_rate: c_int, in_rate: c_int,
                            filter_length: c_int, log2_phase_count: c_int,
                            linear: c_int, cutoff: c_double) ->
     *mut Struct_AVResampleContext)
externfn!(fn av_resample(c: *mut Struct_AVResampleContext, dst: *mut c_short,
                       src: *mut c_short, consumed: *mut c_int,
                       src_size: c_int, dst_size: c_int, update_ctx: c_int) ->
     c_int)
externfn!(fn av_resample_compensate(c: *mut Struct_AVResampleContext,
                                  sample_delta: c_int,
                                  compensation_distance: c_int))
externfn!(fn av_resample_close(c: *mut Struct_AVResampleContext))
externfn!(fn avpicture_alloc(picture: *mut AVPicture,
                           pix_fmt: avutil::Enum_AVPixelFormat, width: c_int,
                           height: c_int) -> c_int)
externfn!(fn avpicture_free(picture: *mut AVPicture))
externfn!(fn avpicture_fill(picture: *mut AVPicture, ptr: *uint8_t,
                          pix_fmt: avutil::Enum_AVPixelFormat, width: c_int,
                          height: c_int) -> c_int)
externfn!(fn avpicture_layout(src: *AVPicture, pix_fmt: avutil::Enum_AVPixelFormat,
                            width: c_int, height: c_int, dest: *mut c_uchar,
                            dest_size: c_int) -> c_int)
externfn!(fn avpicture_get_size(pix_fmt: avutil::Enum_AVPixelFormat, width: c_int,
                              height: c_int) -> c_int)
externfn!(fn avpicture_deinterlace(dst: *mut AVPicture, src: *AVPicture,
                                 pix_fmt: avutil::Enum_AVPixelFormat, width: c_int,
                                 height: c_int) -> c_int)
externfn!(fn av_picture_copy(dst: *mut AVPicture, src: *AVPicture,
                           pix_fmt: avutil::Enum_AVPixelFormat, width: c_int,
                           height: c_int))
externfn!(fn av_picture_crop(dst: *mut AVPicture, src: *AVPicture,
                           pix_fmt: avutil::Enum_AVPixelFormat, top_band: c_int,
                           left_band: c_int) -> c_int)
externfn!(fn av_picture_pad(dst: *mut AVPicture, src: *AVPicture, height: c_int,
...
externfn!(fn avcodec_get_chroma_sub_sample(pix_fmt: avutil::Enum_AVPixelFormat,
                                         h_shift: *mut c_int,
                                         v_shift: *mut c_int))
externfn!(fn avcodec_pix_fmt_to_codec_tag(pix_fmt: avutil::Enum_AVPixelFormat) ->
     c_uint)
externfn!(fn avcodec_get_pix_fmt_loss(dst_pix_fmt: avutil::Enum_AVPixelFormat,
                                    src_pix_fmt:avutil:: Enum_AVPixelFormat,
                                    has_alpha: c_int) -> c_int)
externfn!(fn avcodec_find_best_pix_fmt(pix_fmt_mask: int64_t,
                                     src_pix_fmt: avutil::Enum_AVPixelFormat,
                                     has_alpha: c_int, loss_ptr: *mut c_int)
     -> avutil::Enum_AVPixelFormat)
externfn!(fn avcodec_find_best_pix_fmt_of_list(pix_fmt_list:
                                                 *mut avutil::Enum_AVPixelFormat,
                                             src_pix_fmt: avutil::Enum_AVPixelFormat,
                                             has_alpha: c_int,
                                             loss_ptr: *mut c_int) ->
     avutil::Enum_AVPixelFormat)
externfn!(fn avcodec_find_best_pix_fmt_of_2(dst_pix_fmt1: avutil::Enum_AVPixelFormat,
                                          dst_pix_fmt2: avutil::Enum_AVPixelFormat,
                                          src_pix_fmt: avutil::Enum_AVPixelFormat,
                                          has_alpha: c_int,
                                          loss_ptr: *mut c_int) ->
     avutil::Enum_AVPixelFormat)
externfn!(fn avcodec_find_best_pix_fmt2(dst_pix_fmt1: avutil::Enum_AVPixelFormat,
                                      dst_pix_fmt2: avutil::Enum_AVPixelFormat,
                                      src_pix_fmt: avutil::Enum_AVPixelFormat,
                                      has_alpha: c_int, loss_ptr: *mut c_int)
     -> avutil::Enum_AVPixelFormat)
externfn!(fn avcodec_default_get_format(s: *mut Struct_AVCodecContext,
                                      fmt: *avutil::Enum_AVPixelFormat) ->
     avutil::Enum_AVPixelFormat)
externfn!(fn avcodec_set_dimensions(s: *mut AVCodecContext, width: c_int,
                                  height: c_int))
externfn!(fn av_get_codec_tag_string(buf: *mut c_schar, buf_size: size_t,
                                   codec_tag: c_uint) -> size_t)
externfn!(fn avcodec_string(buf: *mut c_schar, buf_size: c_int,
                          enc: *mut AVCodecContext, encode: c_int))
externfn!(fn av_get_profile_name(codec: *AVCodec, profile: c_int) -> *c_schar)
externfn!(fn avcodec_default_execute(c: *mut AVCodecContext,
                                   func:
                                       extern "C" fn
                                           (arg1: *mut AVCodecContext,
...
externfn!(fn avcodec_default_execute2(c: *mut AVCodecContext,
                                    func:
                                        extern "C" fn
                                            (arg1: *mut AVCodecContext,
                                    ...
                                    arg: *mut c_void, ret: *mut c_int,
                                    count: c_int) -> c_int)
externfn!(fn avcodec_fill_audio_frame(frame: *mut AVFrame, nb_channels: c_int,
                                    sample_fmt: avutil::Enum_AVSampleFormat,
                                    buf: *uint8_t, buf_size: c_int,
                                    align: c_int) -> c_int)
externfn!(fn avcodec_flush_buffers(avctx: *mut AVCodecContext))
externfn!(fn avcodec_default_free_buffers(s: *mut AVCodecContext))
externfn!(fn av_get_bits_per_sample(codec_id: Enum_AVCodecID) -> c_int)
externfn!(fn av_get_pcm_codec(fmt: avutil::Enum_AVSampleFormat, _be: c_int) ->
     Enum_AVCodecID)
externfn!(fn av_get_exact_bits_per_sample(codec_id: Enum_AVCodecID) -> c_int)
externfn!(fn av_get_audio_frame_duration(avctx: *mut AVCodecContext,
                                       frame_bytes: c_int) -> c_int)
externfn!(fn av_register_bitstream_filter(bsf: *mut AVBitStreamFilter))
externfn!(fn av_bitstream_filter_init(name: *c_schar) ->
     *mut AVBitStreamFilterContext)
externfn!(fn av_bitstream_filter_filter(bsfc: *mut AVBitStreamFilterContext,
                                      avctx: *mut AVCodecContext,
                                      args: *c_schar,
                                      poutbuf: *mut *mut uint8_t,
                                      poutbuf_size: *mut c_int, buf: *uint8_t,
     ...
     c_int)
externfn!(fn av_bitstream_filter_close(bsf: *mut AVBitStreamFilterContext))
externfn!(fn av_bitstream_filter_next(f: *mut AVBitStreamFilter) ->
     *mut AVBitStreamFilter)
externfn!(fn av_fast_realloc(ptr: *mut c_void, size: *mut c_uint,
                           min_size: size_t) -> *mut c_void)
externfn!(fn av_fast_malloc(ptr: *mut c_void, size: *mut c_uint,
                          min_size: size_t))
externfn!(fn av_fast_padded_malloc(ptr: *mut c_void, size: *mut c_uint,
                                 min_size: size_t))
externfn!(fn av_fast_padded_mallocz(ptr: *mut c_void, size: *mut c_uint,
                                  min_size: size_t))
externfn!(fn av_xiphlacing(s: *mut c_uchar, v: c_uint) -> c_uint)
externfn!(fn av_log_missing_feature(avc: *mut c_void, feature: *c_schar,
                                  want_sample: c_int))
externfn!(fn av_log_ask_for_sample(avc: *mut c_void, msg: *c_schar))
externfn!(fn av_register_hwaccel(hwaccel: *mut AVHWAccel))
externfn!(fn av_hwaccel_next(hwaccel: *mut AVHWAccel) -> *mut AVHWAccel)
externfn!(fn av_lockmgr_register(cb:
                                   extern "C" fn
                                       (arg1: *mut *mut c_void,
                                        arg2: Enum_AVLockOp) -> c_int) ->
     c_int)
externfn!(fn avcodec_get_type(codec_id: Enum_AVCodecID) -> avutil::Enum_AVMediaType)
externfn!(fn avcodec_get_name(id: Enum_AVCodecID) -> *c_schar)
externfn!(fn avcodec_is_open(s: *mut AVCodecContext) -> c_int)
externfn!(fn av_codec_is_encoder(codec: *AVCodec) -> c_int)
externfn!(fn av_codec_is_decoder(codec: *AVCodec) -> c_int)
externfn!(fn avcodec_descriptor_get(id: Enum_AVCodecID) -> *AVCodecDescriptor)
externfn!(fn avcodec_descriptor_next(prev: *AVCodecDescriptor) ->
     *AVCodecDescriptor)
externfn!(fn avcodec_descriptor_get_by_name(name: *c_schar) ->
     *AVCodecDescriptor)
