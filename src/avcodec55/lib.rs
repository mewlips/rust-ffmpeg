...
use libc::{c_void,c_int,c_uint,c_schar,size_t,uint8_t,int64_t,c_double,uint64_t,c_float,int16_t,uint32_t,c_short,uint16_t,c_uchar};
...
pub struct Struct_AVCodec {
    ...
    pub encode2: ::std::option::Option<extern "C" fn
                                           (arg1: *mut AVCodecContext,
                                            arg2: *mut AVPacket,
                                            arg3: *avutil::AVFrame, arg4: *mut c_int)
                                           -> c_int>,
...
extern "C" {
    ...
    pub fn av_packet_unpack_dictionary(data: *uint8_t, size: c_int,
                                       dict: *mut *mut avutil::AVDictionary) -> c_int;
    ...
    pub fn avcodec_default_get_buffer2(s: *mut AVCodecContext,
                                       frame: *mut avutil::AVFrame, flags: c_int) ->
     c_int;
    ...
    pub fn avcodec_default_execute2(c: *mut AVCodecContext,
                                    ...
                                    arg: *mut c_void, ret: *mut c_int,
                                    count: c_int) -> c_int;
    pub fn avcodec_fill_audio_frame(frame: *mut avutil::AVFrame, nb_channels: c_int,
