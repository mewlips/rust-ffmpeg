...
extern "C" {
    ...
    pub fn av_append_packet(s: *mut AVIOContext, pkt: *mut avcodec::AVPacket,
                            size: c_int) -> c_int;
    pub fn av_stream_get_r_frame_rate(s: *AVStream) -> avutil::AVRational;
    ...
    pub fn av_format_get_video_codec(s: *AVFormatContext) -> *mut avcodec::AVCodec;
    pub fn av_format_set_video_codec(s: *mut AVFormatContext,
                                     c: *mut avcodec::AVCodec);
    pub fn av_format_get_audio_codec(s: *AVFormatContext) -> *mut avcodec::AVCodec;
    pub fn av_format_set_audio_codec(s: *mut AVFormatContext,
                                     c: *mut avcodec::AVCodec);
    pub fn av_format_get_subtitle_codec(s: *AVFormatContext) -> *mut avcodec::AVCodec;
    ...
    pub fn av_write_uncoded_frame(s: *mut AVFormatContext,
                                  stream_index: c_int, frame: *mut avutil::AVFrame) ->
     c_int;
    pub fn av_interleaved_write_uncoded_frame(s: *mut AVFormatContext,
                                              stream_index: c_int,
                                              frame: *mut avutil::AVFrame) -> c_int;
