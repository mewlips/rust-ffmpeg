#[link(name = "swscale", vers = "2.2.100")];
#[license = "MIT"];
#[crate_type = "lib"];
...
externfn!(fn swscale_version() -> c_uint)
externfn!(fn swscale_configuration() -> *c_schar)
externfn!(fn swscale_license() -> *c_schar)
externfn!(fn sws_getCoefficients(colorspace: c_int) -> *c_int)
externfn!(fn sws_isSupportedInput(pix_fmt: avutil::Enum_AVPixelFormat) -> c_int)
externfn!(fn sws_isSupportedOutput(pix_fmt: avutil::Enum_AVPixelFormat) -> c_int)
externfn!(fn sws_alloc_context() -> *mut Struct_SwsContext)
externfn!(fn sws_init_context(sws_context: *mut Struct_SwsContext,
                            srcFilter: *mut SwsFilter,
                            dstFilter: *mut SwsFilter) -> c_int)
externfn!(fn sws_freeContext(swsContext: *mut Struct_SwsContext))
externfn!(fn sws_getContext(srcW: c_int, srcH: c_int,
...
externfn!(fn sws_allocVec(length: c_int) -> *mut SwsVector)
externfn!(fn sws_getGaussianVec(variance: c_double, quality: c_double) ->
     *mut SwsVector)
externfn!(fn sws_getConstVec(c: c_double, length: c_int) -> *mut SwsVector)
externfn!(fn sws_getIdentityVec() -> *mut SwsVector)
externfn!(fn sws_scaleVec(a: *mut SwsVector, scalar: c_double))
externfn!(fn sws_normalizeVec(a: *mut SwsVector, height: c_double))
externfn!(fn sws_convVec(a: *mut SwsVector, b: *mut SwsVector))
externfn!(fn sws_addVec(a: *mut SwsVector, b: *mut SwsVector))
externfn!(fn sws_subVec(a: *mut SwsVector, b: *mut SwsVector))
externfn!(fn sws_shiftVec(a: *mut SwsVector, shift: c_int))
externfn!(fn sws_cloneVec(a: *mut SwsVector) -> *mut SwsVector)
externfn!(fn sws_printVec2(a: *mut SwsVector, log_ctx: *mut avutil::AVClass,
                         log_level: c_int))
externfn!(fn sws_freeVec(a: *mut SwsVector))
externfn!(fn sws_getDefaultFilter(lumaGBlur: c_float, chromaGBlur: c_float,
                                lumaSharpen: c_float, chromaSharpen: c_float,
                                chromaHShift: c_float, chromaVShift: c_float,
                                verbose: c_int) -> *mut SwsFilter)
externfn!(fn sws_freeFilter(filter: *mut SwsFilter))
externfn!(fn sws_getCachedContext(context: *mut Struct_SwsContext, srcW: c_int,
                                ...
                                dstFilter: *mut SwsFilter, param: *c_double)
     -> *mut Struct_SwsContext)
externfn!(fn sws_convertPalette8ToPacked32(src: *uint8_t, dst: *mut uint8_t,
                                         num_pixels: c_int,
                                         palette: *uint8_t))
externfn!(fn sws_convertPalette8ToPacked24(src: *uint8_t, dst: *mut uint8_t,
                                         num_pixels: c_int,
                                         palette: *uint8_t))
externfn!(fn sws_get_class() -> *avutil::AVClass)
