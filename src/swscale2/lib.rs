...
use libc::{c_void,c_uint,c_int,uint8_t,c_double,c_float,c_uchar};
...
extern "C" {
    ...
    pub fn sws_getContext(srcW: c_int, srcH: c_int,
                          srcFormat: avutil52::Enum_AVPixelFormat, dstW: c_int,
                          dstH: c_int, dstFormat: avutil52::Enum_AVPixelFormat,
    ...
    pub fn sws_printVec2(a: *mut SwsVector, log_ctx: *mut avutil52::AVClass,
                         log_level: c_int);
    ...
    pub fn sws_getCachedContext(context: *mut Struct_SwsContext, srcW: c_int,
                                srcH: c_int, srcFormat: avutil52::Enum_AVPixelFormat,
                                dstW: c_int, dstH: c_int,
                                dstFormat: avutil52::Enum_AVPixelFormat, flags: c_int,
                                srcFilter: *mut SwsFilter,
                                dstFilter: *mut SwsFilter, param: *c_double)
     -> *mut Struct_SwsContext;
    ...
    pub fn sws_convertPalette8ToPacked24(src: *uint8_t, dst: *mut uint8_t,
                                         num_pixels: c_int,
                                         palette: *uint8_t);
    pub fn sws_get_class() -> *avutil52::AVClass;
}
